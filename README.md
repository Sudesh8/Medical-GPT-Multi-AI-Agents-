...
FAISS-based Document Retrieval: Implements FAISS for efficient vector search and ranking.

Natural Language Processing: Utilizes advanced language models for response generation.

Interactive Streamlit UI: Enables real-time document uploads, queries, and response generation.
...
Query Parser: Extracts key terms and topics from user queries.

Document Retriever: Searches stored documents for relevant matches using FAISS.
